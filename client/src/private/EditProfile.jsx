...
function EditProfile() {
  ...
  const handleEditProfile = async (event) => {
    ...
    const data = {
      ...(professionalStatus.value && { status: professionalStatus.value }),
      ...
      ...(githubusername.value && { githubusername: githubusername.value }),
      social: {
    ...
    try {
      ...
      dispatch(notifyAndClear("Profile Updated", "success", 3));
    } catch (error) {
  ...
  return (
    <Container className="mt-3">
      <div className="d-flex justify-content-between align-items-baseline">
        <h2 className="font-weight-bolder text-info">Edit Profile</h2>
      ...
      <p className="lead">Edit your profile to make it up-to-date</p>
      <Card>
        <Card.Body>
          <Card.Title className="text-info">Update Profile</Card.Title>
          <hr />
          <Form onSubmit={handleEditProfile}>
            ...
            <Form.Group>
              ...
              <Form.Control {...skills} placeholder="Lion, Zebra, Camel" />
              <Form.Text className="text-muted">
            ...
            <Button type="submit" variant="info" className="font-weight-bold">
              <i className="fas fa-redo-alt"></i> Update
            </Button>
          </Form>
        </Card.Body>
      </Card>
